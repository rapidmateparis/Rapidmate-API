...
exports.getItems = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch service. Please try again later.',1001));
  }
}
...
exports.updateItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to update service. Pleast try again later.',1001));
  }
...
exports.createItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to create service. Please try again later.',1001));
  }
}
...
exports.deleteItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to delete service. Please try again later.',1001));
  }
}