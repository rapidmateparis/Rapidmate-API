...
const updateItem = async (id,req) => {
    const registerQuery = `UPDATE rmt_planning_setup SET PLAN_NAME ='${req.plan_name}',PLAN_DESCRIPTION='${req.plan_description}',IS_DEL='${req.is_del}' WHERE ID ='${id}'`;
...
const createItem = async (req) => {
    const registerQuery = `INSERT INTO rmt_planning_setup (PLAN_NAME,PLAN_DESCRIPTION) VALUES ('${req.plan_name}','${req.plan_description}')`;
    const registerRes = await runQuery(registerQuery);
    return registerRes;
}
