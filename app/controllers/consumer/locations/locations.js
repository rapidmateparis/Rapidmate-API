...
exports.getItems = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch locations. Please try again later.',1001));
  }
}
...
exports.getItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch location. Please try again later.',1001));
  }
}
...
exports.updateItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to update location. Please try again later.',1001));
  }
...
exports.createItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to create location. Please try again later.',1001));
  }
}
...
exports.deleteItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to delete location. Please try again later.',1001));
  }
}