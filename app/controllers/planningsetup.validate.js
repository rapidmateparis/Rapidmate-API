...
exports.createItem = [
    ...
    check('delivery_boy_id').optional(),
    ...
    check('repeat_type').optional(),
    check('repeat_day').optional().isNumeric().withMessage('Is repeat must be a number 1 0r 0'),
    check('repeat_till').optional(),
    check('repeat_day_exception').optional(),
    check('repeat_on_day').optional(),
    check('repeat_on_the').optional(),
