...
exports.getItems = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unble to fetch states. Please try again later.',1001));
  }
}
...
exports.getItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch state. please try again later.',1001));
  }
}
...
exports.createItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to create state. Please try again later.',1001));
  }
}
...
exports.deleteItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to delete state. Please try again later.',1001));
  }
}