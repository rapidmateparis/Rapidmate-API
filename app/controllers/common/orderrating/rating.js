...
exports.getItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObjectForLog(503, error, 'Unable to fetch rating. Please try again later.',1001));
  }
}
...
exports.createItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObjectForLog(503, error, 'Unable to create rating. Please try again later.',1001));
  }
}
