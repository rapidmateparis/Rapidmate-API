  ...
  try {
    ...
    if(getId){
      ...
      if (updatedItem.affectedRows >0) {
        ...
        return res.status(500).json(utils.buildErrorMessage(500,'Unable to update about us. Please try again later.',1001));
      }
    }
  ...
  try {
    ...
    if (!doesNameExists) {
      ...
      if(item.insertId){
        ...
        return res.status(500).json(utils.buildErrorMessage(500,'Unable to create about us. Please try again later.',1001));
      }
    }else{
  ...
  try {
    ...
    if(getId){
      ...
      if (deletedItem.affectedRows > 0) {
        ...
        return res.status(500).json(utils.buildErrorMessage(500,'Unable to delete about us. Please try again later.',1001));
      }
    }
