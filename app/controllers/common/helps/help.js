...
const { FETCH_SUPPORT_QUERY,FETCH_SUPPORT_BY_ID, UPDATE_SUPPORT_QUERY, INSERT_SUPPORT_QUERY, DELETE_SUPPORT_QUERY } = require('../../../repo/database.query')
...
exports.getItems = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch supports. Please try again later.',1001));
  }
}
...
exports.getItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to fetch support. Please try again later.',1001));
  }
}
...
exports.updateItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to update support. Please try again later.',1001));
  }
...
exports.createItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to create support. Please try again later.',1001));
  }
}
...
exports.deleteItem = async (req, res) => {
  try {
    ...
    return res.status(500).json(utils.buildErrorObject(503, error, 'Unable to delete support. Please try agin later.',1001));
  }
}