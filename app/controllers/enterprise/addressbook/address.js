...
const { FETCH_ENTERPRISE_ADDRESS_BOOK_QUERY, INSERT_ENTERPRISE_ADDRESS_BOOK_QUERY, DELETE_ENTERPRISE_ADDRESS_BOOK_QUERY, transformKeysToLowercase,} = require('../../../repo/database.query')
