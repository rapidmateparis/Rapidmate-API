...
const { FETCH_PAYMENTEMETHOD_ALL, FETCH_PAYMENTEMETHOD_BY_ID, FETCH_PAYMENTEMETHOD_BY_EXTID, UPDATE_PAYMENTEMETHOD, INSERT_PAYMENTEMETHOD, DELETE_PAYMENTEMETHOD } =require('../../../db/database.query')
/********************
 * Public functions *
 ********************/
/**
...
const createItem = async (req) => {
    const registerRes = await insertQuery(INSERT_PAYMENTEMETHOD,[req.enterprise_ext,req.card_number,req.card_holder_name,req.expiration_date,req.cvv,req.is_del]);
    return registerRes;
}
