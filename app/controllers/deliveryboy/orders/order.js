...
exports.updateOrderStatus = async (req, res) => {
  try {
    ...
    if (requestData.status == "Ready to pickup") {
      ...
      deliveredOtp =
        ", delivered_otp = (LPAD(FLOOR(RAND() * 9999.99),4,  '0'))";
