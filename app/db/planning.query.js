...
exports.INSERT_SLOTS_QUERY = `INSERT INTO rmt_planning_setup_slot (planning_setup_id, day, from_time, to_time) VALUES ?`;
...
exports.FETCH_DELIVERY_BOY_PLANNING_SETUP_SLOT_QUERY = `select year,month,week,day,from_time,to_time from rmt_planning planning left join rmt_planning_setup plansetup on planning.id=plansetup.planning_id left join rmt_planning_setup_slot setupslot on plansetup.id=setupslot.planning_setup_id where planning.delivery_boy_id=? and year=? and month=? and week=? order by year asc, month asc, week asc, day asc, from_time asc`;