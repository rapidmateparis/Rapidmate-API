...
exports.DELETE_ORDER_QUERY = `UPDATE rmt_order SET is_enable_cancel_request=0, order_status = 'CANCELLED', cancel_reason_id =?, cancel_reason = ?,consumer_order_title = ?, delivery_boy_order_title = ?, updated_on = ? WHERE id=?`;
