...
//=================================rmt_shift_and_slots=====================================================================================================
exports.INSERT_SHIFT_SLOTS_QUERY = `INSERT INTO rmt_enterprise_order_slot (branch_id, enterprise_order_id, day, from_time, to_time, slot_date, order_number, per_hour_amount,total_hours,total_days,total_amount,delivery_boy_amount) VALUES (?, ?, ?, ?, ?, ?, (select order_number from rmt_enterprise_order where id=?),?,?,?,?,?)`;
