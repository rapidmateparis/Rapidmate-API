...
exports.FETCH_SLOTS_BY_SHIFT_ID=`SELECT slot.id,day,from_time,to_time,is_selected,slot_date,order_status,next_action_status,shift_started_on,shift_completed_on,total_hours,per_hour_amount,total_amount,order_number,total_duration,total_duration_text,total_days,delivery_boy_amount, boy.* FROM rmt_enterprise_order_slot slot left join rmt_delivery_boy boy on slot.delivery_boy_id = boy.id where enterprise_order_id = ?`
