...
exports.FETCH_SLOTS_BY_SHIFT_ID=`SELECT slot.id,day,from_time,to_time,is_selected,slot_date,order_status,next_action_status,shift_started_on,shift_completed_on,total_hours,per_hour_amount,total_amount,order_number,total_duration,total_duration_text,total_days,delivery_boy_amount, boy.first_name, boy.last_name, boy.ext_id FROM rmt_enterprise_order_slot slot , rmt_delivery_boy boy where slot.delivery_boy_id = boy.id and enterprise_order_id = ?`
