...
exports.DELETE_ORDER_QUERY = `UPDATE rmt_enterprise_order SET delivery_boy_id = null, is_enable_cancel_request=0, cancelled_on = now(), order_status = 'CANCELLED', cancel_reason_id =?, cancel_reason = ?,consumer_order_title = ?, delivery_boy_order_title = ?,is_show_datetime_in_title=1, updated_on = now() WHERE id=?`;
...
//=================================rmt_shift_and_slots=====================================================================================================
exports.INSERT_SHIFT_SLOTS_QUERY = `INSERT INTO rmt_enterprise_order_slot (branch_id, enterprise_order_id, day, from_time, to_time, slot_date, order_number, per_hour_amount,total_hours,total_days,total_amount,delivery_boy_amount,commission_percentage,commission_amount) VALUES (?, ?, ?, ?, ?, ?, (select order_number from rmt_enterprise_order where id=?),?,?,?,?,?,?,?)`;
...
exports.FETCH_SLOTS_BY_SHIFT_ID=`SELECT slot.id,day,from_time,to_time,is_selected,slot_date,order_status,next_action_status,shift_started_on,shift_completed_on,total_hours,per_hour_amount,total_amount,order_number,total_duration,total_duration_text,total_days,delivery_boy_amount, boy.first_name, boy.last_name, boy.ext_id FROM rmt_enterprise_order_slot slot left join rmt_delivery_boy boy on slot.delivery_boy_id = boy.id where enterprise_order_id = ?`
